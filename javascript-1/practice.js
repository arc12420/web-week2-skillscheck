...
const enemies = people.filter(name => name.friend === false)
...
var awesome = people.map(function(item) {
    return item.awesomeLevel;
});

let totallyAwesome = awesome.reduce(function (acc, curr){
	return acc + curr;
});
